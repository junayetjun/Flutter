          ...
          Row(
            ...
            children: [
              IconButton(
                ...
                onPressed: () {
                  // FIX 3: Correct navigation to CaregiverProfile
                  if (_caregiverProfileMap != null) {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        // Pass the profile map, which is now of the correct type
                        builder: (context) => CaregiverProfile(profile: _caregiverProfileMap!),
                      ),
                    );
                  } else {
                    _showSnackBar("Profile data not loaded yet.", Colors.orange);
                  }
                },
              ),
              const Text(
